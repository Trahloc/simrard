...
pub mod prelude {
    /*!
    Convenience module with the core types you're most likely to use when working with Big Brain. Mean to be used like `use simrard_lib_utility_ai::prelude::*;`
    */
    use super::*;
    ...
    pub use simrard_utility_ai_derive::{ActionBuilder, ScorerBuilder};
